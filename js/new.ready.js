...
function setEmailInputPlaceholderText(){
    if( $(this).width() < 769 ) {
        ...
        $("#email").attr('placeholder', 'JUST 출시 소식을 가장 먼저 받고 싶다면? 이메일 주소를 입력');
    }
}
...
$(document).ready(function(){
    ...
    $('#SECTION05 .tab-title-text').on('click', function(){
        ...
        $(this).find("img").attr('src', '/images.new/main_pc/g5_tab_0'+ selectedNo +'_over.png')
        $("#TAB2_IMG").attr('src', '/images.new/main_pc/g5_0'+ selectedNo +'.png');
    ...
    // 슬라이더 다음 이미지 프리로딩
    preload([
        '/images.new/main_pc/g4_01.png',
        '/images.new/main_pc/g4_02.png',
        '/images.new/main_pc/g4_03.png'
    ]);
    preload([
        '/images.new/main_pc/g5_01.png',
        '/images.new/main_pc/g5_02.png',
        '/images.new/main_pc/g5_03.png',
        '/images.new/main_pc/g5_04.png',
        '/images.new/main_pc/g5_05.png',
        '/images.new/main_pc/g5_06.png'
    ]);
});
...
$(window).on('resize', function(){
    ...
    // 기타 반응형 대응 필요한 요소 제어
    if( $(this).width() < 769 ) {
        $("#group_06_img").attr('src', '/images.new/main_mobile/g6.png');
        $("#subscribe-button").attr('src', '/images.new/main_mobile/g9_btn.png');
    } else {
        $("#group_06_img").attr('src', '/images.new/main_pc/g6.png');
        $("#subscribe-button").attr('src', '/images.new/main_pc/g9_btn.png');
    }
});
